...
module system_mm_interconnect_0 (
		...
		output wire        realtimeclock_0_avalon_slave_0_chipselect       //                                         .chipselect
	);
	...
	wire         realtimeclock_0_avalon_slave_0_agent_rp_valid;                                      // realtimeclock_0_avalon_slave_0_agent:rp_valid -> router_002:sink_valid
	wire  [65:0] realtimeclock_0_avalon_slave_0_agent_rp_data;                                       // realtimeclock_0_avalon_slave_0_agent:rp_data -> router_002:sink_data
	wire         realtimeclock_0_avalon_slave_0_agent_rp_ready;                                      // router_002:sink_ready -> realtimeclock_0_avalon_slave_0_agent:rp_ready
	wire         realtimeclock_0_avalon_slave_0_agent_rp_startofpacket;                              // realtimeclock_0_avalon_slave_0_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         realtimeclock_0_avalon_slave_0_agent_rp_endofpacket;                                // realtimeclock_0_avalon_slave_0_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire   [2:0] realtimeclock_0_avalon_slave_0_burst_adapter_source0_channel;                       // realtimeclock_0_avalon_slave_0_burst_adapter:source0_channel -> realtimeclock_0_avalon_slave_0_agent:cp_channel
	...
	wire         router_002_src_valid;                                                               // router_002:src_valid -> realtimeclock_0_avalon_slave_0_rsp_width_adapter:in_valid
	wire  [65:0] router_002_src_data;                                                                // router_002:src_data -> realtimeclock_0_avalon_slave_0_rsp_width_adapter:in_data
	wire         router_002_src_ready;                                                               // realtimeclock_0_avalon_slave_0_rsp_width_adapter:in_ready -> router_002:src_ready
	wire   [2:0] router_002_src_channel;                                                             // router_002:src_channel -> realtimeclock_0_avalon_slave_0_rsp_width_adapter:in_channel
	wire         router_002_src_startofpacket;                                                       // router_002:src_startofpacket -> realtimeclock_0_avalon_slave_0_rsp_width_adapter:in_startofpacket
	wire         router_002_src_endofpacket;                                                         // router_002:src_endofpacket -> realtimeclock_0_avalon_slave_0_rsp_width_adapter:in_endofpacket
	wire         realtimeclock_0_avalon_slave_0_rsp_width_adapter_src_valid;                         // realtimeclock_0_avalon_slave_0_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [92:0] realtimeclock_0_avalon_slave_0_rsp_width_adapter_src_data;                          // realtimeclock_0_avalon_slave_0_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire         realtimeclock_0_avalon_slave_0_rsp_width_adapter_src_ready;                         // rsp_demux:sink_ready -> realtimeclock_0_avalon_slave_0_rsp_width_adapter:out_ready
	wire   [2:0] realtimeclock_0_avalon_slave_0_rsp_width_adapter_src_channel;                       // realtimeclock_0_avalon_slave_0_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire         realtimeclock_0_avalon_slave_0_rsp_width_adapter_src_startofpacket;                 // realtimeclock_0_avalon_slave_0_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire         realtimeclock_0_avalon_slave_0_rsp_width_adapter_src_endofpacket;                   // realtimeclock_0_avalon_slave_0_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire         cmd_mux_src_valid;                                                                  // cmd_mux:src_valid -> realtimeclock_0_avalon_slave_0_cmd_width_adapter:in_valid
	wire  [92:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> realtimeclock_0_avalon_slave_0_cmd_width_adapter:in_data
	wire         cmd_mux_src_ready;                                                                  // realtimeclock_0_avalon_slave_0_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire   [2:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> realtimeclock_0_avalon_slave_0_cmd_width_adapter:in_channel
	wire         cmd_mux_src_startofpacket;                                                          // cmd_mux:src_startofpacket -> realtimeclock_0_avalon_slave_0_cmd_width_adapter:in_startofpacket
	wire         cmd_mux_src_endofpacket;                                                            // cmd_mux:src_endofpacket -> realtimeclock_0_avalon_slave_0_cmd_width_adapter:in_endofpacket
	...
	wire   [2:0] realtimeclock_0_avalon_slave_0_cmd_width_adapter_src_channel;                       // realtimeclock_0_avalon_slave_0_cmd_width_adapter:out_channel -> realtimeclock_0_avalon_slave_0_burst_adapter:sink0_channel
	...
	wire         realtimeclock_0_avalon_slave_0_agent_rdata_fifo_src_valid;                          // realtimeclock_0_avalon_slave_0_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [9:0] realtimeclock_0_avalon_slave_0_agent_rdata_fifo_src_data;                           // realtimeclock_0_avalon_slave_0_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         realtimeclock_0_avalon_slave_0_agent_rdata_fifo_src_ready;                          // avalon_st_adapter:in_0_ready -> realtimeclock_0_avalon_slave_0_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                                      // avalon_st_adapter:out_0_valid -> realtimeclock_0_avalon_slave_0_agent:rdata_fifo_sink_valid
	wire   [9:0] avalon_st_adapter_out_0_data;                                                       // avalon_st_adapter:out_0_data -> realtimeclock_0_avalon_slave_0_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                                      // realtimeclock_0_avalon_slave_0_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                                      // avalon_st_adapter:out_0_error -> realtimeclock_0_avalon_slave_0_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.av_chipselect          (realtimeclock_0_avalon_slave_0_chipselect),             //                         .chipselect
