...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="C:/programs/altera_lite/16.0/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/soc_system_jtag_uart_0.v"        -work jtag_uart_0             -cdslib ./cds_libs/jtag_uart_0.cds.lib            
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/soc_system_hps_0.v"              -work hps_0                   -cdslib ./cds_libs/hps_0.cds.lib                  
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/submodules/altera_address_span_extender.sv" -work address_span_extender_0 -cdslib ./cds_libs/address_span_extender_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/soc_system.vhd"                                                                                                             
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/soc_system_rst_controller.vhd"                                                                                              
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/soc_system_rst_controller_001.vhd"                                                                                          
fi
